...
const ControlsLayout: React.FC<ControlsLayoutProps> = ({content}) => {
    const {account, description, ...rest} = content;
    return (
        <div className={styles.layout}>
            <div className={styles.sidebar}>
                <div></div>
                <div className={styles['sidebar-content']}>
                    <CardSidebar content={rest}/>
                </div>
            </div>
            <div className={styles.footer}>
                <CardFooter account={account} description={description}/>
            </div>
